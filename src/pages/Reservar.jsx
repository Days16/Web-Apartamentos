...
export default function Reservar() {
  ...
  const bookingComUrl = settings?.booking_com_url || '';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(lang === 'ES' ? 'Error al enviar. Inténtalo de nuevo.' : 'Error sending. Please try again.');
    } finally {
      setSending(false);
    }
  };
  ...
  const ES = {
    title: 'Reservar — Illa Pancha',
    hero: 'Haz tu reserva',
    sub: 'Contáctanos directamente o reserva a través de Booking.com',

    contactTitle: 'Contacto directo',
    contactDesc: 'Escríbenos o llámanos. Te respondemos en menos de 24 horas.',
    nameLbl: 'Nombre',
    emailLbl: 'Email',
    phoneLbl: 'Teléfono (opcional)',
    msgLbl: 'Mensaje',
    msgPlaceholder: '¿En qué fechas te interesa? ¿Para cuántas personas?',
    send: 'Enviar consulta',
    sending: 'Enviando…',
    sentTitle: 'Mensaje enviado',
    sentDesc: 'Gracias, te responderemos lo antes posible.',
    whatsappLabel: 'WhatsApp',
    backContact: 'Ver página de contacto completa →',

    bookingTitle: 'Reservar en Booking.com',
    bookingDesc: 'También puedes consultar disponibilidad y reservar directamente en Booking.com.',
    bookingBtn: 'Ver en Booking.com',
    bookingNote: 'Se abrirá en una nueva pestaña.',
  };

  const EN = {
    title: 'Book — Illa Pancha',
    hero: 'Make a reservation',
    sub: 'Contact us directly or book through Booking.com',

    contactTitle: 'Direct contact',
    contactDesc: 'Write to us or call us. We reply within 24 hours.',
    nameLbl: 'Name',
    emailLbl: 'Email',
    phoneLbl: 'Phone (optional)',
    msgLbl: 'Message',
    msgPlaceholder: 'What dates are you interested in? For how many guests?',
    send: 'Send enquiry',
    sending: 'Sending…',
    sentTitle: 'Message sent',
    sentDesc: 'Thank you, we will reply as soon as possible.',
    whatsappLabel: 'WhatsApp',
    backContact: 'See full contact page →',

    bookingTitle: 'Book on Booking.com',
    bookingDesc: 'You can also check availability and book directly on Booking.com.',
    bookingBtn: 'View on Booking.com',
    bookingNote: 'Opens in a new tab.',
  };
  ...
  return (
    <>
      ...
      {/* DOS COLUMNAS */}
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="p-8 border-b border-gray-100">
            <div className="flex items-center gap-3 mb-1">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: '#003580' }}>
              ...
              <h2 className="text-2xl font-serif font-bold text-navy">{C.bookingTitle}</h2>
            </div>
            <p className="text-sm text-gray-500 mt-2">{C.bookingDesc}</p>
          </div>
          ...
          <div className="p-8 flex flex-col items-center justify-center min-h-[320px] text-center">
            ...
            <p className="text-gray-600 text-sm mb-8 max-w-xs leading-relaxed">{C.bookingDesc}</p>
            ...
            {bookingComUrl ? (
              <a
                ...
                className="inline-flex items-center gap-2 text-white font-bold px-8 py-4 rounded-xl transition-all hover:opacity-90 shadow-lg text-sm"
                style={{ background: '#003580' }}
              >
                {C.bookingBtn}
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl px-8 py-6 text-gray-400 text-sm">
                {lang === 'ES'
                  ? 'Configura la URL de Booking.com en Ajustes Generales del admin'
                  : 'Configure the Booking.com URL in Admin General Settings'}
              </div>
            )}

            <p className="text-xs text-gray-400 mt-4">{C.bookingNote}</p>
          </div>
        </section>
