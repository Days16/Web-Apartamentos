        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex flex-center items-center justify-center p-8 text-center">
                <div>
                    ...
                    <button onClick={() => navigate('/')} className="bg-teal text-white px-6 py-2 rounded">{T.booking.backHome}</button>
                </div>
            </div>
            <Footer />
        </div>
            ...
            <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-12 md:py-20">
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="bg-teal-600 p-8 text-white text-center">
                        ...
                        <h1 className="text-3xl md:text-4xl font-serif font-bold mb-2">{T.booking.bookingConfirmed}</h1>
                        <p className="text-teal-50 opacity-90">{lang === 'EN' ? 'Hello' : 'Hola'} {res.guest}, {T.booking.stayReady}</p>
                    </div>

                    <div className="p-8 md:p-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            <div>
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">{T.booking.stayDetails}</h3>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-gray-500">{res.nights} {res.nights === 1 ? T.common.night : T.common.nights}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">{T.booking.paymentInfo}</h3>
                                <div className="space-y-4">
                        ...
                        <div className="border-t border-gray-100 pt-8 flex flex-col gap-4">
                            ...
                            <p className="text-center text-xs text-gray-400 mt-4 leading-relaxed">
                                {T.booking.confirmationEmail} <strong>{res.id}</strong>.
                            </p>
                        </div>
                    </div>
                </div>
