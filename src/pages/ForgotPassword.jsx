                ...
                {sent ? (
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <button
                            ...
                            style={{ marginTop: '16px', background: 'none', border: 'none', color: '#D4A843', cursor: 'pointer', fontSize: '14px' }}
                        >
                            Volver al login
                        </button>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <p style={{ opacity: 0.6, fontSize: '14px', marginTop: 0, marginBottom: '24px', textAlign: 'center' }}>
