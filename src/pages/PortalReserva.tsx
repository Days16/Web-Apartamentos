      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-12 md:py-20">
        <div className="max-w-md mx-auto mb-12 text-center">
          ...
          <p className="text-gray-600">
            Introduce tus datos para consultar el estado de tu estancia o descargar tu factura.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-700 mt-0.5">
                        Esta es la información disponible antes de las 48h de ingreso, para que puedas
                        revisarla con tranquilidad.
                      </p>
                    </div>
                  </div>
