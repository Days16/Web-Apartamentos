    ...
    <>
      ...
      <div className="py-20 md:py-28 px-4 bg-gradient-to-br from-navy to-navy-dark">
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="text-sm font-semibold text-teal uppercase tracking-widest mb-4">{C.heroEyebrow}</div>
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6" dangerouslySetInnerHTML={safeHtml(C.heroTitle)} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-20 px-4 max-w-6xl mx-auto">
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                  <div>
                    <label className="text-sm font-semibold text-navy block mb-2">{C.labelName}</label>
                    <input
                  ...
                  <div>
                    <label className="text-sm font-semibold text-navy block mb-2">{C.labelEmail}</label>
                    <input
                      type="email"
                      className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                  <div>
                    <label className="text-sm font-semibold text-navy block mb-2">{C.labelPhone}</label>
                    <input
                      className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
                  ...
                  <div>
                    <label className="text-sm font-semibold text-navy block mb-2">{C.labelApt}</label>
                    <select className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base cursor-pointer focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all" value={form.apt} onChange={up('apt')}>
                ...
                <div className="mb-5">
                  <label className="text-sm font-semibold text-navy block mb-2">{C.labelMsg}</label>
                  <textarea
                    className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
        ...
        <div>
          ...
          <div className="flex gap-4">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="#25D366" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 mt-1">
