      ...
      <div className="w-full min-h-screen bg-white">
        ...
        <div className="policy-content max-w-3xl mx-auto px-4 py-12">
          <p>
            ...
            turístico ofrecidos por <strong>Illa Pancha Ribadeo</strong> (en adelante, «el
            Propietario» o «nosotros») a través del sitio web <strong>illapancha.com</strong>. Al
            realizar una reserva, el cliente (en adelante, «el Huésped») acepta expresamente los
            presentes términos.
          </p>

          <h2>1. Identificación del prestador</h2>
          <p>
            <strong>Denominación:</strong> Illa Pancha Ribadeo S.L. (en constitución)
            <br />
            <strong>Domicilio:</strong> Ribadeo, Lugo, Galicia, España
            <br />
            <strong>Email:</strong> info@apartamentosillapancha.com
            <br />
            <strong>Teléfono:</strong> +34 982 XXX XXX
          </p>
          ...
          <ul>
            <li>
              <strong>Más de {cancelDays} días antes del check-in:</strong> cancelación gratuita con
              devolución completa del depósito.
            </li>
            <li>
              <strong>
                Entre {Math.round(cancelDays / 2)} y {cancelDays} días antes del check-in:
              </strong>{' '}
              se retiene el 50% del depósito abonado.
            </li>
            <li>
              <strong>Menos de {Math.round(cancelDays / 2)} días antes del check-in:</strong> se
              retiene el 100% del depósito abonado.
            </li>
          </ul>
          <p>
            En caso de fuerza mayor debidamente acreditada (hospitalización, fallecimiento de
            familiar directo, etc.), el Propietario estudiará cada caso individualmente.
          </p>

          <h2>6. Check-in y check-out</h2>
          <ul>
            <li>
              <strong>Check-in:</strong> a partir de las 15:00 horas del día de llegada. Fuera de
              este horario deberá coordinarse con el Propietario.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              No organizar fiestas o eventos sin autorización previa y por escrito del Propietario.
            </li>
          ...
          <h2>8. Mascotas</h2>
          <p>
            Las mascotas solo se admiten en los apartamentos expresamente indicados como
            «pet-friendly». En los demás, no está permitida su presencia. El incumplimiento de esta
          ...
          <p>
            Todos los contenidos del sitio web illapancha.com (textos, imágenes, logotipos, diseño)
            son propiedad del Propietario o de sus licenciantes y están protegidos por la normativa
            de propiedad intelectual. Queda prohibida su reproducción sin autorización expresa.
          </p>
