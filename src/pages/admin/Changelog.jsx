                                ...
                                <div key={entry.id} className="relative pl-8 border-l-2 border-gray-200 py-1">
                                    ...
                                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                                        <div className="flex flex-wrap items-center gap-3 mb-4">
                                            <span className="text-sm font-bold text-[#82c8bd] font-mono">{entry.version}</span>
                                        ...
                                        {entry.description && <p className="text-gray-600 text-sm mb-4 leading-relaxed">{entry.description}</p>}
