export const paths = {
  ...
  photo:
    'M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z M12 17a4 4 0 100-8 4 4 0 000 8',
  ...
  phone:
    'M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8a19.79 19.79 0 01-3.07-8.68A2 2 0 012.18 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.18 6.18l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z',
  ...
  bed: 'M2 4v16M2 8h20v12H2M22 4v4H2M6 12h2M6 16h2',
  bath: 'M2 12h20v5a2 2 0 01-2 2H4a2 2 0 01-2-2v-5zM7 12V6a1 1 0 011-1h2a1 1 0 011 1v6',
...
export default function Ico({
  ...
  const pathData =
    typeof d === 'string' && (paths as Record<string, string>)[d]
      ? (paths as Record<string, string>)[d]
      : d;
